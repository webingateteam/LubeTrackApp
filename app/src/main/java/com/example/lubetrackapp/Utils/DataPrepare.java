...
import com.example.lubetrackapp.BuildConfig;
...
public class DataPrepare {
    ...
    public static com.example.lubetrackapp.Utils.DataPrepare getdataInstance(Context context) {

        if (instance == null) {
            instance = new com.example.lubetrackapp.Utils.DataPrepare(context);
        }

        return instance;
    }

    public static com.example.lubetrackapp.Utils.DataPrepare get(Context context) {
        if (instance == null) {
            instance = new com.example.lubetrackapp.Utils.DataPrepare(context);
        }
        return instance;
