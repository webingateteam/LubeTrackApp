...
public class ClientLocationsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void setOnItemClickListener(final ClientLocationsAdapter.OnItemClickListener mItemClickListener) {
        this.itemClickListener = mItemClickListener;
    }

    public ClientLocationsAdapter(List<BuildingResponse> locslist) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       ...
       // if (viewType == VIEW_TYPE_ITEM) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.client_loc_items, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder ItemViewHolder, int position) {
        ...
        if (ItemViewHolder instanceof ItemViewHolder) {
            ...
            ClientLocationsAdapter.ItemViewHolder holder = (ClientLocationsAdapter.ItemViewHolder) ItemViewHolder;
